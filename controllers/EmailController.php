...
/**
 * EmailController implements the CRUD actions for TBEMAIL model.
 */
class EmailController extends Controller
{
    ...
    /**
     * Displays a single TBEMAIL model.
     * @param string $id
     * @return mixed
     */
    ...
    /**
     * Updates an existing TBEMAIL model.
    ...
    /**
     * Deletes an existing TBEMAIL model.
