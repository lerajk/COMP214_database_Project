...
/**
 * TBEVENTSSearch represents the model behind the search form about `app\models\TBEVENT`.
 */
class TBEVENTSSearch extends TBEVENT
{
    /**
     * @inheritdoc
     */
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'EVE_NAME', $this->EVE_NAME])
            ->andFilterWhere(['like', 'EVE_DATE_BEGIN', $this->EVE_DATE_BEGIN])
            ->andFilterWhere(['like', 'EVE_DATE_END', $this->EVE_DATE_END])
